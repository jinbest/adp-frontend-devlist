    ...
    return (
        <header className={subDomain + "-header"}>
            ...
            <div className={subDomain + "-container-header"}>
                ...
                <div>
                    <h2>{storesDetails.storesDetails ? storesDetails.storesDetails.name : ""}</h2>
                </div>
                        ...
                        <Feature
                            ...
                            activeComponent={() => (
                                <a
                                    ...
                                    className={subDomain + "-navlink-avatar-store"}
                                    target="_blank"
                                    rel="noreferrer"
                                >
                    ...
                    <div className={subDomain + "-mobile-menu-navbar"}>
                        ...
                        {userStatus ? (
                            <div>
                                {mobileMenu === "left" ? (
                                    <div>
                                        {data.mobileNavItemData.left.map(
                                  ...
                                  <img style={{height: '18px'}} src={data.arrowData.arrowRight} />
                                    ...
                                    <div>
                                        ...
                                        <div className="mobile-scroll-nav-div">
                                            {mobileShopType === 999
                                                ? data.navShop.mainList.map(
                                                      (item: any, index: number) => {
                                                          return (
                                                              <a
                                                                  key={index}
                                                                  className={
                                                                      subDomain + "-mobile-item"
                                                                  }
                                                                  href="#"
                                                                  onClick={() =>
                                                                      setMobileShopType(index)
                                                                  }
                                                              >
                                                                  {item.type}
                                                              </a>
                                            ...
                                            <Feature
                                                ...
                                                activeComponent={() => (
                                                    <a
                                                        href="#"
                                                        style={{
                                                            color: data.colorPalle.textThemeCol,
                                                        }}
                                                    >
                                                        {t("SIGN_OUT")}
                                                    </a>
