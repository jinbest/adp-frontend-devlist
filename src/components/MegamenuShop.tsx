            ...
            <div className={subDomain + '-content-block'}>
              {megaShopData.otherList.map((item:any, index: number) => {
                return (
                  <p className={subDomain + '-block-content'} 
                    key={index}
                    style={{color: (otherListSel === index) ? textThemeCol : ''}}
