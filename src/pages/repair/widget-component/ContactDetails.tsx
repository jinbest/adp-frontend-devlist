...
const ContactDetails = ({data, subDomain, step, handleStep, handleChangeChooseData, features, code}: Props) => {
            ...
            {code !== 'MAIL_IN' && <div className={subDomain + '-repair-choose-device-container'}>
              <FeatureToggles features={features}>
                <Feature
                  ...
                  activeComponent={()=><Button 
                    title={t('BOOK_AN_APPOINTMENT')} bgcolor={mainData.colorPalle.nextButtonCol} borderR='20px' maxWidth='300px' 
              ...
              <FeatureToggles features={features}>
                <Feature
                  ...
                  inactiveComponent={()=><></>}
                  activeComponent={()=><Button 
                    title={t('REQUEST_A_QUOTE')} bgcolor={mainData.colorPalle.nextButtonCol} borderR='20px' maxWidth='300px' 
