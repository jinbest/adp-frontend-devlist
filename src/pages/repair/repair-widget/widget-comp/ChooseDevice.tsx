...
import { Card, PlusSVG, Search, Button } from "./"
...
} from "../service/RepairWidgetCallAPI"
    ...
    const handlePlus = async () => {
        ...
        switch (stepName) {
            case "deviceBrand":
                ...
                if (
                    repairWidData.repairDeviceBrands.data &&
                    repairWidData.repairDeviceBrands.data.length
                ) {
                                        ...
                                        {imageData
                                            ...
                                            .map((item: any, index: number) => {
                                                return (
                                                    <div
                                                        className={
                                                            subDomain + "-device-item-container"
                                                        }
                                                        style={{
                                                            background:
                                                                selected === index
                                                ...
                                                .map((item: any, index: number) => {
                                                    return (
                                                        <div
                                                            ...
                                                            onClick={() =>
                                                                toggleItemTypes(index, stepName)
                                                            }
                                                        >
                                                            <div
                                                                className={
                                ...
                                {estimatedTimes &&
                                    estimatedTimes.map((item: any, index: number) => {
                                        return (
                                            <div
                                                key={index}
                                                className={subDomain + "-estimate-times-div"}
                                            >
                                                <p className={subDomain + "-estimate-title"}>
                                                    {t(item.name)}
                                                </p>
