                                            ...
                                            (chooseItem: any, chooseIndex: number) => (
                                                ...
                                                >
                                                    ...
                                                    <div>
                                                        <Typography
                                                            className={
                                                                subDomain + "-repair-summary-title"
                                                            }
                                                        >
