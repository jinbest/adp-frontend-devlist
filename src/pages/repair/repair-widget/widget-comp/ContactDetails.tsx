...
import { Card, InputComponent, Button, PhoneInput, CustomSelect } from "./"
import RepairSummary from "./RepairSummary"
import { useT } from "../i18n/index"
import { FeatureToggles, Feature } from "@paralleldrive/react-feature-toggles"
import { repairWidgetStore, storesDetails } from "../store"
import { repairWidgetAPI, findLocationAPI } from "../service"
import { PostAppointParams } from "../model/post-appointment-params"
import { countriesData, statesData } from "../const"
import { makeLocations } from "./BookTime"
    ...
    const handleSubmit = (param: string) => {
        ...
        if (param !== "appointment") {
            ...
            params.selected_start_time =
                repairWidgetStore.repairWidgetInitialValue.selected_start_time
