...
const getTabData = (companyName) => {
    return {
        title: `Cell Phone, iPhone & iPad Repair Winnipeg | ${companyName}`,
        metaDescription: `Same day repair of your broken, cracked, smashed or water damaged iPhone, iPad or cell phone in Winnipeg. Call ${companyName} or book your repair online today!`,
    }
}
