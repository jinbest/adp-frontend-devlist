...
const cardMobileData = {
    ...
    data: [
        ...
        { img: buy, title: "SHOP", btnTitle: "SHOP", flag: 'FRONTEND_BUY', href: "http://shop.mobiletechlab.ca/" },
...
const navItemsData = [
    ...
    { href: "http://shop.mobiletechlab.ca/", text: "SHOP", isActive: false, flag: 'FRONTEND_MEGA_MENU' },
...
const avatarData = {
    ...
    cancel: cancel,
    store: { img: store, link: 'http://shop.mobiletechlab.ca/' },
    storeBlue: storeBlue,
    menu: menu
}
