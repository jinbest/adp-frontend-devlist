...
const navItemsData = [
    ...
    { href: "#", text: "Business", isActive: false },
    { href: "#", text: "Financing", isActive: false },
    { href: "#", text: "Wholesale", isActive: false },
]
...
const homeTextData = {
    ...
    section1: {
        ...
        subtitle: 'Okotok’s mobile device specialists',
    ...
    section4: {
        title: 'Welcome to Wireless Revolution, Ottowa\'s mobile device marketplace',
    ...
    section6: {
        title: 'See Why Customers Love Wireless Revolution',
        subtitle: 'View more',
        review: [
            {
                score: 5,
    ...
    section2: {
        ...
        content: [
            ...
            },
            {
                ...
                content: 'Wireless Rev repairs your device and notifies you of pick up or delivery date.',
            }
        ]
    },
    section3: {
        title: 'From New to Reconditioned',
        content: 'Choose your new phone among our 4 grades, with Wireless Rev it\'s easy to choose for any budget!',
        children: [
            {
                subtitle: 'NEW',
