...
const brandItemsData = {
    ...
    right: {ip: "204.221.5898", en: "ENGLISH", log: "LOG_IN"},
    brandCol: 'white',
    brandThemeCol: '#054DFA',
...
const homeTextData = {
    ...
    section1: {
        ...
        subtitle: 'WINNIPEG_MOBILE_DEVICE_SPECIALISTS',
    ...
    section6: {
        title: 'SEE_WHY_CUSTOMERS_LOVE_DEVICELIST',
        subtitle: 'VIEW_MORE',
        review: [
            {
                score: 5,
    ...
    section2: {
        ...
        content: [
            ...
            },
            {
                ...
                content: 'DEVICELIST_RECEIVE_YOUR_DEVICE_CONTENT',
            }
        ]
    },
    section3: {
        title: 'FROM_NEW_TO_RECONDITIONED',
        content: 'DEVICELIST_FROM_NEW_TO_RECONDITIONED_CONTENT',
        children: [
            {
                subtitle: 'NEW',
