...
const contentFixData = [
  ...
  },
  {
    ...
    content:
      "We want you to be confident that you're getting the best price. We'll match any local Peterborough competitor's published price for the same repair and get it done faster.",
  },
  {
