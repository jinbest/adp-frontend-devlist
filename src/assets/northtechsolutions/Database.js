...
const getTabData = (companyName) => {
    return {
        ...
        metaDescription: `Same day repair of your broken, cracked, smashed or water damaged iPhone, iPad or cell phone in Iqaluit. Call ${companyName} or book your repair online today!`,
    }
}
