...
const contentFixData = [
    {
        ...
        content:
            "Not sure what’s wrong with your device? We quickly diagnose your device to find out what the issue is. The diagnostic is free when you do the repair with us!",
    },
    {
...
const homeTextData = {
    ...
    section1: {
        title: ['Winnipeg’s Professional', 'Phone Repair'],
        subtitle: 'Same-Day Advanced Repair Services',
    ...
    section4: {
        title: 'Welcome to Mobile Tech Lab, Manitoba\'s mobile device marketplace',
    ...
    section6: {
        title: 'See Why Customers Love Mobile Tech Lab',
        subtitle: 'View more',
        review: [
            {
                score: 5,
    ...
    section2: {
        ...
        content: [
            ...
            },
            {
                ...
                content: 'Mobile Tech Lab repairs your device and notifies you of pick up or delivery date.',
            }
        ]
    },
    section3: {
